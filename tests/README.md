...
Prerequisites: [HA Matter Hub](https://github.com/RiDDiX/home-assistant-matter-hub) v2.0.48+, iOS/tvOS 18.4+, HAMH configured with `cleaningModeEntity` and `mopIntensityEntity` sub-entries.
