...
> **Purpose:** Reconstructs the original problem statement, goals, and constraints as they existed before implementation began. This is the "what and why" — extracted from session history, protocol notes, and early design decisions. It is not a description of what was built; the current spec set under `../spec/` is the authoritative source for that.
>
